...
export function enhancePageEvent<P extends AnyPayload>(event: Event<P>, options: EnhancedEventOptions = {}): Event<P> {
...
export function usePageEvent(event: EmptyOrPageEvent<any, any>, options: EnhancedEventOptions = {}) {
  assertStrict(event);
